<?php
  ...
  $get_sessions_sql = "SELECT * FROM admin_sessions";
  $get_sessions_result = mysqli_query($dbConn, $get_sessions_sql);
  $get_sessions_array = [];

  function get_all_admin_sessions($sessions_result, $sessions_array) {
    $sessions_array = [];
  ...
  $admin_sessions = get_all_admin_sessions($get_sessions_result, $get_sessions_array);
