...
$duplicate_check_query = "SELECT * FROM admin_users WHERE user_name = '$user_name'";
...
$add_user_query = "INSERT INTO admin_users (user_name, user, role, password) VALUES ('$user_name', '$user', '$role', '$hashedPassword')";
