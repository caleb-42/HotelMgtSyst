...
if ($old_user_name != $user_name) {
	$duplicate_check_query = "SELECT * FROM account_users WHERE role = '$role' AND user_name = '$user_name'";
...
if ($password) {
	$update_user_query = "UPDATE account_users SET user = '$user', role = '$role', user_name = '$user_name', password = '$password' WHERE id = $id";
} else {
	$update_user_query = "UPDATE account_users SET user = '$user', role = '$role', user_name = '$user_name' WHERE id = $id";
}
