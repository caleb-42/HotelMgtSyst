...
if ($old_category != $category_name) {
	$duplicate_check_query = "SELECT * FROM restaurant_item_category WHERE category_name = '$category_name' AND id != $id";
...
$update_category_query = "UPDATE restaurant_item_category SET category_name = '$category_name', cost = $cost WHERE id = $id";
