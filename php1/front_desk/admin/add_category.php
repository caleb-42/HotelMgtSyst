...
$duplicate_id_query = "SELECT * FROM frontdesk_room_category WHERE category_id = '$category_id'";
...
$duplicate_name_query = "SELECT * FROM frontdesk_room_category WHERE category_name = '$category_name'";
...
$add_new_category_sql = "INSERT INTO frontdesk_room_category (category_name, category_id, cost) VALUES('$category_name', '$category_id', $cost)";
