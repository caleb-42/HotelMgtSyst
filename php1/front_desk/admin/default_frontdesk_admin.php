...
$duplicate_check_query = "SELECT * FROM frontdesk_users WHERE user_name = '$user_name'";
...
$add_user_query = "INSERT INTO frontdesk_users (user_name, user, role, password) VALUES ('$user_name', '$user', '$role', '$hashedPassword')";
