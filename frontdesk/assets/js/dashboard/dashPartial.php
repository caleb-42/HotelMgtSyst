                        ...
                        <div class="mb-5 item-container">
                            <div class="userlisthd row justify-content-between">
                                ...
                                <div class="my-4">
                                    ...
                                    <button class="btn btn-outline-warning mx-1 font-fam-Montserrat f-12" ng-click="settings.modal.active = 'Pay'; settings.modal.name = 'Pay Balance'; settings.modal.size = 'lg';" data-toggle="modal" data-target="#crud">Pay</button>
