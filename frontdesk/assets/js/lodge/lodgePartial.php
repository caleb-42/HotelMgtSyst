<div ng-controller="lodge">
            ...
            <div class="animate-switch-container" ng-switch on="tabnav.selected.name">
                <div class="animate-switch Rooms px-4 h-100" ng-switch-default>
                    <div class="prodlisthd row justify-content-between">
                        ...
                        <button class="btn btn-outline-primary mx-1 font-fam-Montserrat f-12" ng-click="settings.modal.active = 'Room'; settings.modal.name = 'Add Room'; settings.modal.size = 'md'; rooms.categories.getCategories()" data-toggle="modal" data-target="#crud" >Add</button><button class="btn btn-outline-success mx-1 font-fam-Montserrat f-12" data-toggle="modal" data-target="#crud" ng-click="settings.modal.active = 'Room'; settings.modal.name = 'Update Room'; settings.modal.size = 'lg'; rooms.categories.getCategories()" ng-disabled="!rooms.jslist.selected">Update</button><button class="btn btn-outline-danger mx-1 font-fam-Montserrat f-12" ng-disabled="!rooms.jslist.selected" ng-click = "rooms.deleteRoom()">Delete</button>
                        </div>
                ...
                <div  class="animate-switch Rooms px-4 h-100" ng-switch-when="Category">
                    <div class="catlisthd row justify-content-between">
                        <h4 class=" my-4 py-2 font-fam-Montserrat-bold">Manage Category</h4>
                        <div class="my-4 row justify-content-between align-items-center">

                        <div class = "catcrudbtns my-4 align-items-center ">
                        <button class="btn btn-outline-primary mx-1 font-fam-Montserrat f-12" ng-click="settings.modal.active = 'Category'; settings.modal.name = 'Add Category'; settings.modal.size = 'md' " data-toggle="modal" data-target="#crud" >Add</button><button class="btn btn-outline-success mx-1 font-fam-Montserrat f-12" data-toggle="modal" data-target="#crud" ng-click="settings.modal.active = 'Category'; settings.modal.name = 'Update Category'; settings.modal.size = 'lg'; " ng-disabled="!category.jslist.selected">Update</button><button class="btn btn-outline-danger mx-1 font-fam-Montserrat f-12" ng-disabled="!category.jslist.selected" ng-click = "category.deleteCategory()">Delete</button>
                        </div>

                        </div>
                    </div>
                    <div class="rmlist h-80">
                        <categorylist class="font-fam-Montserrat"></categorylist>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="clr"></div>
    <div class="modal fade" id="crud" role="dialog" roomsmodalentry></div>
</div>
